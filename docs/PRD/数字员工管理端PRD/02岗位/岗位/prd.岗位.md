...
8. **运行**（`runtime`）：占位页签，展示"🚧 运行 · 开发中"（2026-09-10 负责人拍板保留）。
9. **效果测试**（`effectTest`）：占位页签，展示"🚧 效果测试 · 开发中"（2026-09-10 负责人拍板保留）。
...
人格页签包含 6 个配置区域，纵向排列：岗位图标、岗位描述、领用页文案、示例问题、岗位 SOP、岗位人格。
...
- **右侧编辑区**：
  ...
  - 选中任务或点击新增后，展示任务编辑表单（分 4 个配置区：基本信息 / 调度计划 / 提示词 / 引用工具 / 引用平台技能）。
